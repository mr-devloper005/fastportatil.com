...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-3xl border border-black/10 bg-white p-8 text-center', className)}>
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-full border border-black/15 px-5 py-3 text-sm font-bold transition hover:bg-[#3665f3] hover:text-white hover:border-[#3665f3]">
        {actionLabel}
